...
function dorea_cashback_campaign_credit():void
{
    ...
    print('
            ...
            <div id="doreadoreaBeforeTrxModal" class="!fixed !mx-auto !left-0 !right-0 !top-[20%] !bg-white !w-96 shadow-[0_5px_25px_-15px_rgba(0,0,0,0.3)] !p-10 !rounded-md !text-center !border" style="display: none">
