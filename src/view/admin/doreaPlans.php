...
function doreaPlans()
{
    ...
    print ('<button id="doreaBuy">buy</button>');
    ...
    print('  <script type="module">
         ...
         function delay(){
             (async () => {
                    ...
                    document.getElementById("doreaBuy").addEventListener("click", async () => {
                              ...
                              if (window.ethereum) {
                                ...
                                xhr.onreadystatechange = async function() {
                                    if (xhr.readyState === 4 && xhr.status === 200) {
                                        ...
                                        const contract = new ethers.Contract("0xBe4C2e39F7fCda75d035f5c3bdefb3eA359Cca0d", abi, signer);
