    ...
    print("
        <main>
          <div class='!container !pl-5 !pt-2 !pb-5 !shadow-transparent  !rounded-md'>
            ...
            forexample, user \"A\" purchased $4, you set %10 as amount for your campaign, which means %10 of $4 per user: $0.4. it will converted to ETH format: 0.00016 ETH.
            ...
            forexample, if you set 4 value as shopping counts, it means user must purchases 4 times to be eligible to pay cashback, 
            the cashback amount will be calculated by percentage of final 4 times purchases.
            user \"A\" purchases 4 times: $4 + $8 + $19 + $7 = $38 . if you set %10 as amount in previous step, dorea cashback calculate %10 of $38 to pay user which is $3.8. 
            ...
            0.0004 ETH is equal to $1 until this document is written. for example, you could set 0.4 equals to $1000 to reward you users. 
